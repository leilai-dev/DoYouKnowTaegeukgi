...
const SvgAr = props => {
  return (
    <Svg width={800} height={500} viewBox="0 0 800 500" {...props}>
      ...
      <G id="prefix__c">
        ...
        />
        <Use xlinkHref="#prefix__a" transform="rotate(22.5 400 250)" />
        <Use xlinkHref="#prefix__a" transform="rotate(45 400 250)" />
        <Use xlinkHref="#prefix__a" transform="rotate(67.5 400 250)" />
        <Path
          id="prefix__b"
          fill="#85340a"
        ...
        />
        <Use xlinkHref="#prefix__b" transform="rotate(22.5 400 250)" />
        <Use xlinkHref="#prefix__b" transform="rotate(45 400 250)" />
        <Use xlinkHref="#prefix__b" transform="rotate(67.5 400 250)" />
      </G>
      <Use xlinkHref="#prefix__c" transform="rotate(90 400 250)" />
      <Use xlinkHref="#prefix__c" transform="rotate(180 400 250)" />
      <Use xlinkHref="#prefix__c" transform="rotate(270 400 250)" />
      <Circle
        r={27.778}
        stroke="#85340a"
        cy={250}
      ...
      />
      <Use xlinkHref="#prefix__d" transform="matrix(-1 0 0 1 800.25 0)" />
      <Use xlinkHref="#prefix__e" transform="matrix(-1 0 0 1 800.25 0)" />
      <Use xlinkHref="#prefix__f" transform="translate(18.862)" />
      <Use xlinkHref="#prefix__g" transform="matrix(-1 0 0 1 800.25 0)" />
      <Path
      ...
      />
      <Use xlinkHref="#prefix__h" transform="translate(-19.181)" />
      <Circle id="prefix__f" cy={246.15} cx={390.54} r={1.923} fill="#85340a" />
      <Path
        id="prefix__g"
        fill="#85340a"
